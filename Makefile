...
lint-py:  ## run python linter with ruff
	python -m ruff check polars_io_tools
	python -m ruff format --check polars_io_tools
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix polars_io_tools
	python -m ruff format polars_io_tools
...
test-py:  ## run python tests
	python -m pytest -v polars_io_tools/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v polars_io_tools/tests --cov=polars_io_tools --cov-report term-missing --cov-report xml
